...
## Prompting Style
- Use structured reasoning and synthesis from existing architecture patterns.
- Show decision traceability: what was considered, what was chosen, and why.
- Keep outputs implementation-ready with concrete next actions.
