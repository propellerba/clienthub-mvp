...
## Prompting Style
- Start with a short execution plan and explicit assumptions.
- State tradeoffs before choosing a non-obvious implementation path.
- Prefer deterministic, patch-oriented output with clear file-by-file intent.
